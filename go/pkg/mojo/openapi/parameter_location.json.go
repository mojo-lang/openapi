...
func init() {
	core.RegisterJSONTypeDecoder("openapi.Parameter_Location", &ParameterLocationCodec{})
	core.RegisterJSONTypeEncoder("openapi.Parameter_Location", &ParameterLocationCodec{})
}
