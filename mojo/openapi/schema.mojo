...
type Schema {
    enum Type {
        ...
        array   @5 //<  An ordered list of instances, from the JSON "array" production
        object  @6 //< An unordered set of properties mapping a string to an instance, from the JSON "object" production
    }
    ...
    //{
        ...
        properties: {String: Schema} @26

        additional_properties: {String: Schema} @27
